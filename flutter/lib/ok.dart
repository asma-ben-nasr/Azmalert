                  ...
                  children: <Widget>[
                    Card(
                      ...
                      CircularProgressIndicator(
                        strokeWidth: 15,
                        valueColor: (iaq >= 101) ? new AlwaysStoppedAnimation<Color>(Colors.red) : (iaq >= 51 && iaq <= 100) ? new AlwaysStoppedAnimation<Color>(Colors.yellow) : new AlwaysStoppedAnimation<Color>(Colors.green),
                        value: iaq,
                      ),
                    ),
                    */
...
class _AzmalertPageState extends State<AzmalertPage> {
  ...
  _getStringFromSharedPref() async {
    ...
    _number= prefs.getString("Mobile")??"" ;
    print(_number);
    return(_number);
  ...
  void _disconnect(i) async {
    _subscription?.cancel();
    if (_connection[i] != null) {
      await _connection[i].cancel();
